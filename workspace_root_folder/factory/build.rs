...
fn main() {
    let build_opts = cargo_near_build::BuildOpts::builder()
        .manifest_path(camino::Utf8PathBuf::from("../product-donation").join("Cargo.toml"))
        .build();
    ...
    let extended_build_opts = cargo_near_build::extended::BuildOptsExtended::builder()
        ...
        .passed_env(bon::vec!["KEY", "GOOGLE_QUERY"])
        .result_file_path_env_key("BUILD_RS_SUB_BUILD_ARTIFACT_1")
        .prepare()
